...
router.get("/get-withdraw-history",getAdminWithdrawHistory);
router.get("/get-wallet-percent",getAdminWalletpercent);
router.put("/update-wallet-percent",updateWalletPercent);
